...
function Open()
{
	//Begin document
	$this->state=1;
	$this->author = 'Adresaro';
	$this->creator = 'Copyright (C) 2006 N.V.';
}
...
// à définir individuellement.  Exemple:
...
//	$this->Text($xpos, $ypos + $height + 4,$code); // pour afficher les chiffres
	$this->SetFillColor(0);
...
* @param $fill int              // Fill the nodes; default=0 (0=N, 1=Y)
